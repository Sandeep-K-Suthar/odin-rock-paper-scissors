...
// win stratgy
            switch (human) {
                case "Rock":
                    (computerPlay[show] == "Scissors") ? console.log(`human wins!`) : console.log(`computer wins!`);
                    break;
                case "Paper":
                    (computerPlay[show] == "Rock") ? console.log(`human wins!`) : console.log(`computer wins!`);
                    break;
                case "Scissors":
                    (computerPlay[show] == "Paper") ? console.log(`human wins!`) : console.log(`computer wins!`);
                    break;
            }
        }
    }
